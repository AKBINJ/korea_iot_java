...
class Pizza {
    ...
    public static class Builder {
        // static : Pizza 클래스가 인스턴스화 되지 않을 때 내무 Builder 클래스로 인스턴스화 진행
        // 외부크랠스명.내부클래스명();
        ...
        // 선택 빌드 : 기본값 설정 (추가하지 않으면 해당 값으로 입력)
...
public class E_Builder {
    public static void main(String[] args) {
        ...
        Pizza optonalPizza2 = new Pizza.Builder("쉬림프 피자", "L")
                .addPepperoni()
                .build();
