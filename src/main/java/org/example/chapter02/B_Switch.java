...
public class B_Switch {
    public static void main(String[] args) {
        ...
        System.out.println("Chapter를 선택");
        ...
        switch (chapter){
            case 1:
                ...
                // System.out.println("hi"); - 해당 내용 출력 X
            case 2:
            ...
            case 3:
                ...
                break;
            default:
                System.out.println("유요한 chapter가 아닙니다");
                break;
        }
        ...
        switch (fruit){
            ...
            case "grape":
                ...
                break;
            default:
                System.out.println("유요한 과일이 아닙니다");
        ...
        if (score >= 90){
            ...
            System.out.println("평균적인 성적");
        } else{
            System.out.println("조금만 더 노력");
        }
