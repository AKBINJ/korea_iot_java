...
public class A_If {
    public static void main(String[] args) {
        ...
        int age = 14;
        if (age > 19) {
            //조건이 참일 경우 실행(age는 19를 초과하는 모든 수가 될수 있음)
            System.out.println("성인");
        } else {
            //조건식이 거짓인 경우 실행 (age는 19 이하릐 모든 수)
            System.out.println("미성연자");
        }
        ...
        // 예제 3) 나이 분류 (중괄호 생략)
        // : 조건문에서 실행될 코드 블럭({})에 코드가 하나의 구문이 경우 {} 생략 가능
