...
public class D_While {
    public static void main(String[] args) {
        ...
        */
        ...
        // cf) for 문으로 1부터 5까지 출력하는 문정을 작성 (초기화는 1)
        ...
        // 1) break
        // : 반복분 내에서 break; 키워드를 만나면 반복문 탈출 (종료)
        ...
        // 초기화
        int number = 0;
        while (true){ // if문 & while문의 조건식은 결과값이 놀리형(Boolean)
        ...
        */
        ...
        do{
            System.out.println("1부터 10 사이의 숫자를 입력");
        ...
        System.out.println("1~10 사이의 숫자를 입력");
        inputNumber = sc.nextInt();
