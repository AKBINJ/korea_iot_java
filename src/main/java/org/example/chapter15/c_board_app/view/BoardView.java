    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("2. 게시글 전제 조회(게시글 목록)");
                ...
                switch (choice) {
                    ...
                    case 3:{
                        ...
                        BoardRequestDto dto = boardController.getBoard(id);
                    ...
                    case 0:
                        ...
                        return;
                    default:
                        System.out.println("잘못된 선택입니다. 0~5 사이의 값을 입력");
                        break;
                }

            } catch (IllegalArgumentException e) {
                // 인수값으로 부적절한 값을 넘길 떄 발생하는 예외
