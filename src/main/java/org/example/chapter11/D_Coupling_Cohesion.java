...
*       >> 한 모듈 내에서 구성요소들 연관성
*
*   - 낮은 응집도: 하난의 클래스가 너무 많은 일을 하거나, 관련 없는 일을 하는 것
...
class KoreanTeacher implements Teacher {
    @Override
    public void teach() {
        System.out.println("국어선생님은 국어를 가르칩니다.");
    }
}
...
class MathTeacher implements Teacher {
    @Override
    public void teach() {
        System.out.println("수학선생님은 수학을 가르칩니다");
    }
}
...
// : 제어의 생성과 관리를 개발자가 아닌 "외부 컨테이너(Spring 등)"가 당당하게 하는 구조
