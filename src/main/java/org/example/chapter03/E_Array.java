...
// 장점) 기본 데이터 타입 사용 가능 - int, char, boolean등
//      , 요소 접근 속도가 빠름 (인덱스 기반)
// 단점)
// : 한 번 생성되면 크기 변경 X
// : 크기 변경이 필요한 경우, 변경된 크기의 배열을 생성하여 요소값을 복사
...
public class E_Array {
    public static void main(String[] args) {
        ...
        // == 자바 동적 배열(ArrayList)
        // : Java 의 동적 배열 구현체 (내부적 배열을 사용하지만, 자동으로 크기 조절됨)
        ...
        // cf) Wrapper 클래스
        // : 자바의 기본 타임을 객체 형태로 감싸서 사요할 수 있도록 만든 클래스
