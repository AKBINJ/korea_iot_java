...
// == 클래스 == //
// : 파일 (코드 저장소)
// : 한 개의 .java 파일에는 하나의 클래스가 포함(파일명과 동일)
// - 모든 코드가 클래스 안에서 동작
public class A_Array { // 클래스명 == 파일명 ( 파일명은 대문자로 시작 + UpperCamelCase 사용)
    ...
    public static void main(String[] args) {
        ...
        // == 배열의 생성(우항)
        // >> new 데이터타입[배열의 길이];
        scores1 = new int[3]; // 요소의 개수가 3인 배열의 생성

        System.out.println(scores1); // [I@2f92e0f4

        // cf) 참조 자료형 - 주소값이 저장
        // : 데이터 배열이 저장된 첫 번쨰 메모리 주소가 저장 (인덱스번호 0번의 주소)
        ...
        // cf) 참조 자료형의 출력
        // : 자바에서 객체를 sout으로 출력하면 내부적으로 객체.toString() 기능을 호출
        // >> 모든 참조 자료형의 집합체
        String a = "안녕";
