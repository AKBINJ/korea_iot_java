...
public class E_DataType {
    public static void main(String[] args) {
        /*
           ...
           1. 데이터 타입 종류
           1) 기본 타입(실제 값)
                - 변수 선언 시 해당되는 자료형 크기만큼의 메모리가 할당
                - 실제 데이터가 저장
           ...
           cf) Stack(스택): 기본타이브이 데이터가 실제 저장 / 참조타입의 주소값이 자장
        ...
        */
        ...
        //short : -32,768 ~ 32.767
        //int : 약 -2.1 ~ 약 2.1억
        //long : 약 -2억 63제곱 ~ 약 2억의 64제곱

        byte byteValue = 127;
        short shortValue = 32767;
        int intValue = 287239874;
        long lonValue = 1232321232123L; // long 타입은 숫자 뒤에 알파벳 L, l을 써서 표기(대문자 권장)
        ...
        // : 실제 데이터 값 사용 안함, 데이터가 저장된 주소값을 가지는 자료형

        // 2-1) 문자열(String)
        // : 문자열(문자 여러 개)를 저장하는 데 사용
        ...
        // << 실습 >> //
        // : 학생이름, 학생 나이, 학생 키, 학생 성별('M', 'F' - 단일 문자), 학생 여부
        // 변수 선언과 본인의 데이터로 초기화
        String studentName = "박진영";
        int studentAge = 25;
        float T = 162.5F;
        char studentGender = 'M';
        boolean isStudent = true;
        System.out.println(studentName + studentAge + T + studentGender + isStudent);
