...
// 2) 다른 패키지 내: import 패키지 경로, 패키지명, 클래스파일명;
...
// : 다른 패키지에서 있는 경우, 해당 클래스를 상속받은 하위 클래스에서만 접근 가능
...
public class A_Modifier {
    public static void main(String[] args) {
        ...
        // protectedClass.myField; - A_Modifier 클래스에서 상속받지 않았기 떄문에 접근 불가
