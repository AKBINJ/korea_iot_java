...
*
* 2. Function<T, R>(변환하다)
* : 입력값을 받아 특정 연산을 수행한 후 결화(R)를 반환
* : 메서드
...
* : 외부에서 값을 가져오거나, 데이터를 생서하여 반환하는 역할
* : 메서드
*       - T get(): 반환
*
* @FunctionalInterface
...
public class E_Lambda {
    public static void main(String[] args) {
        ...
        System.out.println(stringLength.apply("이도경 하이"));
        ...
        System.out.println(lengthAndSquare.apply("이 문자열 깅이의 제곱값은?"));
        ...
        Supplier<Double> randomValue = () -> Math.random(); // 람다를 메서드 참조로 바꿀 수 있음
