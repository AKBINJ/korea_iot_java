...
class OuterClass {
    ...
    void outerMethod() {
        ...
        String localVal = "메서드 로컬 변수";
        // localVal = "메서드 로컬 변수 값 변경";

        final String localFinalVal = "메서드 로컬 변수 (final)";

        class MethodClass {
            void display() {
                System.out.println("로컬 변수에 접근 (Final X): " + localVal); // 유사 final
                System.out.println("로컬 변수에 접근 (Final O): " + localFinalVal); // final
            }
        }
